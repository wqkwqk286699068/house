  ...
  <div class="page-container">
	...
	<el-dialog :title="operation?'新增':'编辑'" width="40%" :visible.sync="dialogVisible" :close-on-click-modal="false">
		<el-form :model="dataForm" label-width="80px" :rules="dataFormRules" ref="dataForm" :size="size"
			...
			<el-form-item label="房源" prop="houseSource">
				<el-input v-model="dataForm.houseSource" auto-complete="off"></el-input>
			</el-form-item>
			<el-form-item label="房源地址" prop="houseAddress">
				<el-input v-model="dataForm.houseAddress" auto-complete="off"></el-input>
			</el-form-item>
  ...
  methods: {
    ...
    initColumns: function() {
      this.columns = [
        ...
        { prop: "houseSource", label: "房源", width: 150 },
        { prop: "houseAddress", label: "房源地址", width: 150 },
